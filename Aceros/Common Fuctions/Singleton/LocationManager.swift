...
class LocationManager: NSObject,CLLocationManagerDelegate {
    ...
    typealias PlaceClosure = ((_ place: GMSPlace?)->Void)
    var placeCompletionHandler: PlaceClosure?
    ...
    func showAutocomplete(vc : UIViewController) {
        
        let autocompleteController = GMSAutocompleteViewController()
        autocompleteController.delegate = self
        
        vc.present(autocompleteController, animated: false) {
...
extension LocationManager: GMSAutocompleteViewControllerDelegate {
    ...
    func viewController(_ viewController: GMSAutocompleteViewController, didAutocompleteWith place: GMSPlace) {
        ...
        if let block = self.placeCompletionHandler {
            block(place)
        }
    }
